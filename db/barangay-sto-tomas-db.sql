...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bsms` /*!40100 DEFAULT CHARACTER SET utf8mb4  */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `users` (
  ...
  `user_type` enum('administrator','staff','user') CHARACTER SET utf8mb4 NOT NULL,
  `avatar` text,
